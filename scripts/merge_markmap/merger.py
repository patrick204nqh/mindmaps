    ...
    for ast_index, ast in enumerate(asts):
        ...
        for element in ast:
            ...
            if element_type == "thematic_break":
                logging.debug(
                    "  Found 'thematic_break', will skip next heading as front matter."
                )
            ...
            if element_type == "heading":
                ...
                logging.info(
                    f"  Found heading: Level {heading_level} - '{heading_text}'"
                )
                ...
                if heading_level == 1:
                    if not main_heading:
                        ...
                        logging.info(
                            f"    Ignoring different main heading: '{heading_text}'"
                        )
                        continue
                ...
                if current_heading:
                    ...
                    logging.info(
                        f"  Found list directly under main heading: '{main_heading}'"
                    )
